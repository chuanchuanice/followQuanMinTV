...
- (id)initWithSlug:(NSString *)slug{
    ...
    fl.itemSize = CGSizeMake(width, width + 25);
...
- (void)viewDidLoad {
    ...
    [self.collectionView registerClass:[TRHomeShowCell class] forCellWithReuseIdentifier:reuseIdentifier];
    MJWeakSelf
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath {
    TRHomeShowCell *cell = [collectionView dequeueReusableCellWithReuseIdentifier:reuseIdentifier forIndexPath:indexPath];
    ...
    cell.addressLb.text = data.position;
    cell.nameLb.text = data.nick;
